...
$setglobal input_name  "MainResults_RMIP1"

*Set the scenario name for output files
$setglobal scenario_name  "ProjectBased_2050_RMIP1"
...
*Set the scenario name for input file
$setglobal input_name  "MainResults_RMIP2"

*Set the scenario name for output files
$setglobal scenario_name  "ProjectBased_2050_RMIP2"
...
*Set the scenario name for input file
$setglobal input_name  "MainResults_RMIP3"

*Set the scenario name for output files
$setglobal scenario_name  "ProjectBased_2050_RMIP3"
...
*Set the scenario name for input file
$setglobal input_name  "MainResults_RMIP4"

*Set the scenario name for output files
$setglobal scenario_name  "ProjectBased_2050_RMIP4"
...
*Set the scenario name for input file
$setglobal input_name  "MainResults_RMIP5"

*Set the scenario name for output files
$setglobal scenario_name  "ProjectBased_2050_RMIP5"
...
*Set the scenario name for input file
$setglobal input_name  "MainResults_RMIP6"

*Set the scenario name for output files
$setglobal scenario_name  "ProjectBased_2050_RMIP6"
