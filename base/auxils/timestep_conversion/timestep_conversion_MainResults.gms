...
SET SUBCATEGORY /ELECTRICITY_SALE,HEAT_SALE,H2_SALE,BIOMETHANE_SALE,GENERATION_CAPITAL_COSTS,GENERATION_FIXED_COSTS,GENERATION_OPERATIONAL_COSTS,
                GENERATION_FUEL_COSTS,GENERATION_TAXES,GENERATION_GRID_TARIFFS,TRANSMISSION_CAPITAL_COSTS,TRANSMISSION_OPERATIONAL_COSTS,
                ...
                GENERATION_OTHER_EMI_TAX,GENERATION_OPPORTUNITY_COSTS_STORAGE,GENERATION_REDISPATCH_COMPENSATION_COST,ELECTRICITY_REDISPATCH_COMPENSATION,
                HEAT_REDISPATCH_COMPENSATION,HYDROGEN_REDISPATCH_COMPENSATION,BIOMETHANE_REDISPATCH_COMPENSATION,
                HYDRO_PROFILE,TAXES,GRID_TARIFFS,TOTAL_PROFIT,ENERGY_SPECIFIC_PROFIT/;
