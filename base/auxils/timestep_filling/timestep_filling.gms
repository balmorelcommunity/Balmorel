* CODE TO FILL THE TIMESTEP NOT USED  WITH DATA FROM TIMESTEPS USED - JUAN GEA BERMUDEZ
...
PARAMETER CHRONOHOUR(SSS,TTT) 'Meaning/size of each time step in each season (1 means 1 hour)';
...
$ifi  exist '../../base/auxils/timestep_filling/input/H2STOVOLTSVAL.gdx'  execute_load  '../../base/auxils/timestep_filling/input/H2STOVOLTSVAL.gdx', H2STOVOLTSVAL;
$ifi not  exist '../../base/auxils/timestep_filling/input/H2STOVOLTSVAL.gdx' H2STOVOLTSVAL(YYY,AAA,GGG,SSS,TTT)=0;
...
$ifi  exist '../../base/auxils/timestep_filling/input/BIOMETHSTOVOLTSVAL.gdx'  execute_load  '../../base/auxils/timestep_filling/input/BIOMETHSTOVOLTSVAL.gdx', BIOMETHSTOVOLTSVAL;
$ifi not  exist '../../base/auxils/timestep_filling/input/BIOMETHSTOVOLTSVAL.gdx' BIOMETHSTOVOLTSVAL(YYY,SSS,TTT)=0;
...
H2STOVOLTSVAL(YYY,AAA,GGG,SSS,TTT)=SUM((ISSS,ITTT)$ST_LINK(ISSS,ITTT,SSS,TTT),H2STOVOLTSVAL(YYY,AAA,GGG,ISSS,ITTT));
BIOMETHSTOVOLTSVAL(YYY,SSS,TTT)=SUM((ISSS,ITTT)$ST_LINK(ISSS,ITTT,SSS,TTT),BIOMETHSTOVOLTSVAL(YYY,ISSS,ITTT));
...
execute_unload  "../../base/auxils/timestep_filling/output/H2STOVOLTSVAL.gdx", H2STOVOLTSVAL;
execute_unload  "../../base/auxils/timestep_filling/output/BIOMETHSTOVOLTSVAL.gdx", BIOMETHSTOVOLTSVAL;
