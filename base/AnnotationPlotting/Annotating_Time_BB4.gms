...
Status 20190411:
 ...
 - Few options/addons are active, GenInvest, TransInvest and a few other are (vqdebug is not)
 - Some equations are excluded in the current model, e.g. QKMINFA, check MODEL BALBASE4
 - Using single or more years
 - I worked mostly using a reduced model size, see options limitY3, limitST, limitCRA near the top of balopt.opt
 - With this: The model as found currently in BalmorelBB4.inc is correctly annotated by Time according to checkanno.gms from 20190308.
$offtext
...
QHYRSMINVOL.stage(IY411,IA,IS3)$(HYRSDATA(IA,"HYRSMINVOL",IS3) AND SUM(IGHYRS$IAGK_HASORPOT(IY411,IA,IGHYRS),1)) = annot_blockFirst;

*  "Hydropower reservoir - maximum level (MWh)"
QHYRSMAXVOL.stage(IY411,IA,IS3)$(HYRSDATA(IA,"HYRSMAXVOL",IS3) AND SUM(IGHYRS$IAGK_HASORPOT(IY411,IA,IGHYRS),1)) = annot_blockFirst;
...
display "End of Annotating_Time_BB4_stages.gms - Equations:",  QOBJ.stage, QEEQ.stage, QHEQ.stage, QGFEQ.stage, QGCBGBPR.stage,  QGCBGEXT.stage,  QGCVGEXT.stage, QGGETOH.stage,  QHYRSSEQ.stage,  QHYRSMINVOL.stage, QHYRSMAXVOL.stage,
QHYMAXG.stage,  QESTOVOLT.stage, QESTOVOLTS.stage,  QESTOVOLT.stage,
QHSTOVOLT.stage, QHSTOVOLTS.stage, QHSTOVOLT.stage, QHSTOLOADT.stage, QHSTOLOADTS.stage, QHSTOLOADTLIM.stage, QHSTOLOADTLIMS.stage,
QESTOLOADTLIM.stage, QESTOLOADTLIMS.stage, QHSTOVGHTLIM.stage, QHSTOVGHTLIMS.stage, QESTOVGETLIM.stage, QESTOVGETLIMS.stage, QHSTOVOLTLIM.stage, QHSTOVOLTLIMS.stage,  QESTOVOLTLIM.stage, QESTOVOLTLIMS.stage,
QXK_UP.stage, QGKE_UP.stage,  QGKE_LO.stage, QGKH_UP.stage, QHYRRDISPATCH.stage, QWNDDISPATCH.stage,  QSOLEDISPATCH.stage,  QSOLHDISPATCH.stage,  QWAVEDISPATCH.stage, QGMAXCF.stage;
...
VHYRS_S.stage(IY411,IA,IS3)$(sum(G,IAGK_HASORPOT(IY411,IA,G))) = annot_blockFirst;
...
* They may not all be here yet
execute_unload "Annotating_Time_BB4_stages"  QOBJ.stage, QEEQ.stage, QHEQ.stage, QGFEQ.stage,
QGCBGBPR.stage, QGCBGEXT.stage, QGCVGEXT.stage,
QHYRSSEQ.stage, QHYRSMINVOL.stage, QHYMAXG.stage,
QESTOVOLT.stage, QESTOVOLTS.stage, QHSTOVOLT.stage, QHSTOVOLTS.stage, QeSTOLOADTlim.stage, QeSTOLOADTlimS.stage, QHSTOLOADT.stage, QHSTOLOADTS.stage, QESTOVGETLIM.stage, QESTOVGETLIMS.stage,
QKEFUELC.stage,QKEFUELR.stage, QKEFUELA.stage, QGMINFUELC.stage,QGMAXFUELC.stage,QGMINFUELR.stage,QGMAXFUELR.stage,QGMINFUELA.stage,QGMAXFUELA.stage,QGMINCF.stage,
QGMAXCF.stage,QGEQCF.stage,QGMINRF.stage,QGMAXRF.stage,QGEQRF.stage, QGMINAF.stage,QGMAXAF.stage,QGEQAF.stage,QKMINFC.stage,QKMAXFC.stage,QKEQFC.stage,QKMINFR.stage,QKMAXFR.stage,QKEQFR.stage,
QKMINFNA.stage,QKMAXFNA.stage, QKEQFNA.stage,QLIMCO2.stage,QLIMSO2.stage,QLIMNOX.stage,QLIMCO2NA.stage,QMAXINVESTCF.stage,QMAXINVESTNAF.stage,
VOBJ.stage, VGE_T.stage, VGH_T.stage, VGF_T.stage,
VHYRS_S.stage,
